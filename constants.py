...
FIELD_WIDTH = 200  # Ширина поля в пикселях
FIELD_HEIGHT = 200  # Высота поля в пикселях

# Начальное количество сущностей
INITIAL_GRASS_COUNT = 10  # Начальное количество травы
INITIAL_HERBIVORE_COUNT = 500  # Начальное количество травоядных
...
# Параметры травы
GRASS_SPAWN_PER_ROUND = 10  # Количество новой травы, появляющейся за раунд
...
HERBIVORE_REPRODUCTION_COUNT = 5  # Количество потомков при размножении
HERBIVORE_GRASS_TO_REPRODUCE = 5  # Количество травы, необходимое для размножения
...
PREDATOR_EATING_TIME = 300  # Время переваривания добычи (раунды)
